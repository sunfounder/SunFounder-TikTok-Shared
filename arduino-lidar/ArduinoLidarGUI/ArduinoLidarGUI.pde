...
void drawRadar() {
  ...
  noFill();
  strokeWeight(2);
  //stroke(98,245,31); // radar lines
  stroke(0, 220, 246); // light blue, radar lines
  // draws the arc lines
...
void drawObject() {
  ...
  translate(width/2, height-height*0.074); // moves the starting coordinats to new location
  strokeWeight(9);
  //stroke(255, 10, 10); // red, object
  //stroke(255, 0, 255); // purple, object
  stroke(252, 130, 25); // purple, object
...
void drawLine() {
  pushMatrix();
  strokeWeight(9);
  //stroke(30, 250, 60); // bright green, scan line
  stroke(17, 227, 238); // light blue, scan line
  translate(width/2, height-height*0.074); // moves the starting coordinats to new location
...
void drawText() { // draws the texts on the screen
  ...
  // fill(98, 245, 31);
  fill(0, 220, 246); // light blue, under text
  textSize(25);
  ...
  textSize(25);
  fill(0, 220, 246); // light blue, angle text
